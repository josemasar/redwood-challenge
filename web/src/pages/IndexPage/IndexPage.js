...
const IndexPage = () => {
  return (
    ...
    <div className="container mx-auto min-w-full h-28 bg-gray-800 opacity-95">
      <nav className="flex flex-row">
        ...
        <div className="container flex justify-end">
          ...
          <button className="h-14 w-28 mt-6 mr-10 bg-yellow-200 hover:bg-white border-yellow-400 border-solid border-4 rounded-xl
          font-medium text-2xl text-black">
            Log in
          </button>
          </Link>
          <button className="h-14 w-28 mt-6 mr-32 bg-yellow-200 hover:bg-white border-yellow-400 border-solid border-4 rounded-xl
          font-medium text-2xl text-black">
            Register
          </button>
        </div>
    ...
    <div className="container mx-auto min-w-full min-h-full flex flex-auto justify-center
    bg-gradient-to-tl from-purple-600 via-indigo-400 to-green-500">
      ...
      Rapidly control cost of industrial goods</h1>
    </div>
    <div className="container mx-auto mt-40">
      ...
      The next world´s smartest solution to lower costs in high complex assembled products</h4>
    </div>
    </>
  )
}
